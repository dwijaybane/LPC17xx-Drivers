...
/********************************************************************//**
* @brief		Initializes the PWMx peripheral according to the specified
*               parameters.
* @param[in]	PWMx: PWM peripheral, should be LPC_PWM1
* @param[in]	IntFlag: PWM interrupt flag, should be:
* 				- PWM_MR0: PWM match channel 0
* 				- PWM_MR1: PWM match channel 1
* 				- PWM_MR2: PWM match channel 2
* 				- PWM_MR3: PWM match channel 3
* 				- PWM_MR4: PWM match channel 4
* 				- PWM_MR5: PWM match channel 5
* 				- PWM_MR6: PWM match channel 6
* 				- PWM_CR0: capture input 0
* 				- PWM_CR1: capture input 1
* @return 		None
*********************************************************************/
void PWM_Config(LPC_PWM_TypeDef *PWMx, PWM_PCFG_TYPE PCfg)
{
	// configuration for PWM
	PWM_TIMERCFG_Type PWMCfgDat;
	// Match configuration for PWM
...
/* Note: PWM Channel 1 is in single mode as default state and  can not be changed to double edge mode */
		 case PWM_MR1:
			 // Configure P2.0 as PWM1
			 PinCfg.Pinnum = 0;
