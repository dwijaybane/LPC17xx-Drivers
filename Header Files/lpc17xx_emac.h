...
/*                       PHY Select                                           */
/******************************************************************************/
#define 	DP83848C_SEL       0	         // Specify the type of interface
#define 	KSZ8031_SEL        1

/******************************************************************************/
/*                       UART Mode validation                                 */
/******************************************************************************/
#if (DP83848C_SEL == KSZ8031_SEL)
	#error PHY is not correctly selected
#endif

#if DP83848C_SEL
	#define DP83848C_MODE
#elif KSZ8031_SEL
	#define KSZ8031_MODE
#else
	#error PHY not selected
#endif
...
#ifdef  KSZ8031_MODE
#define EMAC_DEF_ADR             0x0000
#define EMAC_KSZ8031_ID          0x00221550  /* PHY Identifier*/
#endif
