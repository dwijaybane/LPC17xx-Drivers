...
typedef enum
{
	PWM_MR0 =0, /*!< Config for PWM Match channel 0*/
	PWM_MR1 =1, /*!< Config for PWM Match channel 1*/
	PWM_MR2 =2, /*!< Config for PWM Match channel 2*/
	PWM_MR3 =3, /*!< Config for PWM Match channel 3*/
	PWM_MR4 =4, /*!< Config for PWM Match channel 4*/
	PWM_MR5 =5, /*!< Config for PWM Match channel 5*/
	PWM_MR6 =6, /*!< Config for PWM Match channel 6*/
	PWM_CR0 =7, /*!< Config for Capture channel 0  */
	PWM_CR1 =8, /*!< Config for Capture channel 1  */
	None    =9  /*!< No Channel Configuration      */
}PWM_PCFG_TYPE;
