...
* 			support for EXTI firmware library on LPC17xx
* @version	1.0
* @date		20. Dec. 2013
...
typedef enum
{
	EXTI_POLARITY_FALLING_EDGE,	/*!< Low active or falling edge sensitive
												depending on pin mode */
	EXTI_POLARITY_RISING_EDGE	/*!< High active or rising edge sensitive
												depending on pin mode */
} EXTI_POLARITY_ENUM;
