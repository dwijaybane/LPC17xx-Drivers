...
* 			support for MCPWM firmware library on LPC17xx
* @version	1.0
* @date		02. Dec. 2013
 ...
 * @{
 */
/** @brief MCPWM Channel type */
typedef enum
{
	MCPWM_MR0 =1, /*!< Config for PWM Match channel 0*/
	MCPWM_MR1 =2, /*!< Config for PWM Match channel 1*/
	MCPWM_MR2 =3, /*!< Config for PWM Match channel 2*/
	MCPWM_CR0 =4, /*!< Config for PWM Capture channel 0*/
	MCPWM_CR1 =5, /*!< Config for PWM Capture channel 1*/
	MCPWM_CR2 =6  /*!< Config for PWM Capture channel 2*/
}MCPWM_PCFG_TYPE;

/** @brief MCPWM Mode type */
typedef enum
{
	MCPWM_DC =1,  /*!< Config for DC Mode */
	MCPWM_AC =2,  /*!< Config for AC Mode */
	None          /*!< Not in any mode */
}MCPWM_MODE_TYPE;

/** @brief MCPWM INT type */
typedef enum
{
	MCPWM_INT_ENABLE =1, /*!< Config Int Enable */
	MCPWM_INT_DISABLE=2  /*!< Config Int Disable*/
}MCPWM_INT_TYPE;
