...
typedef enum
{
	TIM_MR0 =0, /*!< Config for Ext Match channel 0*/
	TIM_MR1 =1, /*!< Config for Ext Match channel 1*/
	TIM_MR2 =2, /*!< Config for Ext Match channel 2*/
	TIM_MR3 =3, /*!< Config for Ext Match channel 3*/
	TIM_CR0 =4, /*!< Config for Capture channel 0  */
	TIM_CR1 =5, /*!< Config for Capture channel 1  */
	None    =6  /*!< No Channel Configuration      */
}TIM_PCFG_TYPE;
 ...
 * @{
 */
/* Init TIM Configuration functions -----------*/
